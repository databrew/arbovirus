...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q6.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q11.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q12.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q13.Rmd"))}
