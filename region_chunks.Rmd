...
text <- paste0( text, "#### Arboviruses that have circulated autochthonously in the country at any time since 2000 (ref Q5)\n\n" )
text <- paste0( text, "```{r}\n\n")
write_file( text, paste0("new_dashboard/", params$region, "/Q5.Rmd") )
```

```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q5.Rmd"), append=TRUE)}
...
```{r}
text <- "\n```\n\n"
write_file( text, paste0("new_dashboard/", params$region, "/Q5.Rmd"), append=TRUE )
```

```{r}
text <- "\n#### Written arbovirus surveillance plans\n\n"
text <- paste0( text, "#### Surveillance plans and the viruses covered (ref Q6, 6b)\n\n" )
text <- paste0( text, "```{r}\n\n")
write_file( text, paste0("new_dashboard/", params$region, "/Q6.Rmd") )
```

```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q6.Rmd"), append=TRUE)}
...
```{r}
text <- "\n```\n\n"
write_file( text, paste0("new_dashboard/", params$region, "/Q6.Rmd"), append=TRUE )
```
...
```{r}
text <- "\n```\n\n"
text <- paste0( text, "\n`r specific_programme` reported having a specific arbovirus programme, whereas `r another_programme` had arboviral disease surveillance integrated into another programme. No programme reported by `r no_programme`.\n\n") 
write_file( text, paste0("new_dashboard/", params$region, "/Q6.Rmd"), append=TRUE )
```
...
text <- paste0(text, "* _Advanced training_ : statistical software for data analysis (e.g.  STATA, R, SAS, Tableau, etc)) and GIS\n\n")
write_file( text, paste0("new_dashboard/", params$region, "/Q6.Rmd"), append=TRUE )
```
...
text <- paste0(text, "\n```{r}\n\n")
write_file( text, paste0("new_dashboard/", params$region, "/Q11.Rmd"))
```

```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q11.Rmd"), append=TRUE)}
...
text <- paste0( text, "\n```{r}\n\n")
write_file( text, paste0("new_dashboard/", params$region, "/Q11.Rmd"), append=TRUE)
```
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q14.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q15.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q16.Rmd"))}
...
caption <- "Testing capacity by virus and assay type"
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q18.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q19.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q20.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q24.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q25.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q26.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q27.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q28.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q29.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q33.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q34.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q35.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q35c.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q37.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q37b.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q40.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q41.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q42.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q43.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q43e.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q44.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q44b.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q46.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q47.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q49.Rmd"))}
...
```{cat, engine.opts=list(file=paste0("new_dashboard/", params$region, "/Q50.Rmd"))}
