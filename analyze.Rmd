...
- Only count subquestions as missing if they should have been answered!!
...
for(i in 1:nrow(data)){
  ...
  if( !is.na(country) & country != "Iceland"){
  ...
  if( length( missing ) > 0 ){
    cat( paste( country, ":", paste(missing, collapse=", "), "\n") )
  }
  }
}
...
During the last 2 years, did your country conduct national epidemiological surveillance for arboviral disease in animals (eg, epizootic surveillance for yellow fever in endemic areas)?
...
Is there either a surveillance and outbreak response committee in your country, or a steering committee for that purpose?
...
Does your country have a contingency plan to organize healthcare services during an outbreak (including outbreaks of arboviral diseases)?
...
Is there a record of _Aedes aegypti_ or _Aedes albopictus_ being found in your country in the past 5 years? Please choose only one of the following
...
Please describe the potential public health threat from Aedes aegypti in your country
...
other <- responses %>% 
  ...
  group_by(Other) %>%
  tally %>% 
  rename("Response" = "Other")

regulartable( rbind(selection,other) ) %>%
  autofit 
...
Please describe the potential public health threat from Aedes albopictus in your country
...
Please provide total number of cases and deaths for the following arboviral diseases from 2015 to 2020 (if available)
...
Were cases of other mosquito-borne arboviruses, not listed in the previous question, reported in your country from 2015-2020?
...
Please select any of the following other mosquito-borne viruses that have been reported in your country from 2015-2020
...
Please provide the number of cases of locally acquired, mosquito-borne Aedes-borne arbovirus infections by case classification for 2020 and, if not available, for 2019
