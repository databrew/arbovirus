...
**N.B. This table needs to be wider, with a header row giving region names; some of the other 3-way tables will probably look better that way. This is next on the to-do list!**
...
**Question 17** :  Overall, what arboviral testing capacity(ies) is(are) available in your country? Please check all applicable boxes`summarise()` has grouped output by 'Arbovirus'. You can override using the `.groups` argument.
