...
Names and contact details of persons completing the survey on behalf of the countries is shown in Appendix I.
...
flextable( df ) %>% 
  ...
  vline( part="body")  %>% 
  set_caption("Testing capacity by virus and assay type")
