...
$(document).on('click', function (e){
    ...
    /* regional-navigation__abroviral_disease data  */
    var regional_menu_opened = $('#regional-navigation__abroviral_disease').hasClass('in');
    if(!$(e.target).closest('#regional-navigation__abroviral_disease').length &&
        !$(e.target).is('#regional-navigation__abroviral_disease') &&
        regional_menu_opened === true) {
            $('#regional-navigation__abroviral_disease').collapse('toggle');
    }
