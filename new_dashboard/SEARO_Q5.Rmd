...
output:
  html_document:
    includes:
      in_header: SEARO_Q5_header.html
params:
  region: SEARO
---
...
As expected, no countries reported autochthonous yellow fever virus (YFV) transmission. In addition, both India and Indonesia 
reported circulation of Japanese encephalitis virus. 
