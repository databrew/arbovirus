...
> `r if(!is.na(data$SII06)){ data$SII06 }`
...
> `r if(!is.na(data$SII11)){ data$SII11 }`
...
> `r if(!is.na(data$SII12)){ data$SII12 }`
...
> `r if(!is.na(data$SII12c)){ data$SII12c }`
...
> `r if(!is.na(data$SII14)){ data$SII14 }`
...
> `r if(!is.na(data$SIII19d)){ data$SIII19d }`
...
> `r if(!is.na(data$SIII20)){ data$SIII20 }`
...
> `r if(!is.na(data$SIV21)){ data$SIV21 }`
...
> `r if(!is.na(data$SIV25)){ data$SIV25 }`
...
> `r if(!is.na(data$SV28)){ data$SV28 }`
...
> `r if(!is.na(data$SV28d)){ data$SV28d }`
...
> `r if(!is.na(data$SV37)){ data$SV37 }`
...
> `r if(!is.na(data$SV39)){ data$SV39 }`
...
> `r if(!is.na(data$SV40)){ data$SV40 }`
...
> `r if(!is.na(data$SVI41)){ data$SVI41 }`
...
> `r if(!is.na(data$SVI41c)){ data$SVI41c }`
...
> `r if(!is.na(data$SVI42)){ data$SVI42 }`
...
> `r if(!is.na(data$SVII43)){ data$SVII43 }`
...
> `r if(!is.na(data$SVIII47)){ data$SVIII47 }`
...
> `r if(!is.na(data$SVIII48)){ data$SVIII48 }`
...
> `r if(!is.na(data$SVIII51)){ data$SVIII51 }`
...
> `r if(!is.na(data$SVIII53)){ data$SVIII53 }`
...
> `r if(!is.na(data$SVIII54)){ data$SVIII54 }`
...
> `r if(!is.na(data$SIX55b)){ data$SIX55b }`
...
> `r if(!is.na(data$SX65)){ data$SX65 }`
