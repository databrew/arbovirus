...
kable(responses, col.names=NULL, format="latex", linesep=c("\\addlinespace"), booktabs=TRUE) %>%
...
# kable( responses, col.names=NULL)
kable(responses, col.names=NULL, format="latex", linesep=c("\\addlinespace"), booktabs=TRUE)  %>%
  kable_styling( full_width=TRUE ) %>% 
...
kable(responses, col.names=NULL, format="latex", linesep=c("\\addlinespace"), align=c('l','l'), booktabs=TRUE) %>%
  kable_styling( full_width=TRUE ) %>% 
  column_spec(1, width="4in")
```
\end{center}
...
# kable(other_reported, col.names = NULL)
