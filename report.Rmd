...
responses <- responses %>% pivot_longer( everything(), names_to="Arbovirus", values_to="Response" )
}
...
responses <- responses %>% pivot_longer( everything(), names_to="Level", values_to="Tools" )
}
flextable( responses ) %>% autofit
# knitr::kable(responses)
```
...
responses <- responses %>% pivot_longer( everything(), names_to="Arbovirus", values_to="Cases" )
}
flextable( responses ) %>% autofit
# knitr::kable(responses)
```
