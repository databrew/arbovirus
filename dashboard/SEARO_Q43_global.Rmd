---
title: ' '
pagetitle: 'SEARO Q43 global'
output:
  html_document:
    includes:
      in_header: SEARO_Q43_global_header.html
params:
  region: SEARO
---
...
nums %>% 
  ...
  footnote( j=2, 
            part = "header", 
            value = as_paragraph("Percentages are based on the number of countries from each region that responded to Q43"),
            ref_symbols = "a") %>%
