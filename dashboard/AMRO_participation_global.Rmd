---
title: ' '
pagetitle: 'AMRO participation global'
output:
  html_document:
    includes:
      in_header: AMRO_participation_global_header.html
params:
  region: AMRO
---
...
make_map_global(df = data %>% dplyr::select(country = SI01) %>% mutate(value = 'Participated'), pal = 'Set2')
```
