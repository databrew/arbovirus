---
title: ' '
pagetitle: 'SEARO participation global'
output:
  html_document:
    includes:
      in_header: SEARO_participation_global_header.html
params:
  region: SEARO
---
...
#### Responding countries and response rate by WHO region 
...
data %>% 
  ...
  mutate( response_rate = paste0(100*( round(n_respondents / n_countries, 3) ), "%") ) %>%
  select( Region, n_respondents, n_countries, response_rate, respondents ) %>%
  rename("Countries that responded" = respondents,
