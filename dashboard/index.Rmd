...
pd_dengue <- joined[joined$Dengue == 'Yes',] %>% mutate(lng = jitter(lng, factor = jitter_factor), lat = jitter(lat, factor = jitter_factor))
pd_yellow_fever <- joined[joined$`Yellow fever` == 'Yes',] %>% mutate(lng = jitter(lng, factor = jitter_factor), lat = jitter(lat, factor = jitter_factor))
pd_zika <- joined[joined$Zika == 'Yes',] %>% mutate(lng = jitter(lng, factor = jitter_factor), lat = jitter(lat, factor = jitter_factor))
