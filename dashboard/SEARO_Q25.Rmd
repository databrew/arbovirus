...
output:
  html_document:
    includes:
      in_header: SEARO_Q25_header.html
params:
  region: SEARO
---
...
```{r eval = amro}
disclaimer <- "#### Question 25 was not included in the dataset shared with AMRO for completion. Please see the Arbovirus Survey Overview for more information."
```
