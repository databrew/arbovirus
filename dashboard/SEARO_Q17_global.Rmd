---
title: ' '
pagetitle: 'SEARO Q17 global'
output:
  html_document:
    includes:
      in_header: SEARO_Q17_global_header.html
params:
  region: SEARO
---
...
chikv_denv %>%
  ...
  footnote( i = 1, j=c(3:7,9:13), 
            part = "header", 
            value = as_paragraph("Percentages are based on the number of countries from each region that responded to Q17"),
            ref_symbols = "a") %>%
